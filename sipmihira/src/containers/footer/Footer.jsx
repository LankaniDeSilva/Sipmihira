...
import sipmihiraLogo from '../../assets/logo.svg';
import './footer.css';

const Footer = () => (
  <div className="sipmihira__footer section__padding">
    <div className="sipmihira__footer-heading">
      <h1 className="gradient__text">Do you want to step in to the future before others</h1>
    </div>

    <div className="sipmihira__footer-btn">
      <p>Request Early Access</p>
    </div>

    <div className="sipmihira__footer-links">
      <div className="sipmihira__footer-links_logo">
        <img src={sipmihiraLogo} alt="sipmihira_logo" />
